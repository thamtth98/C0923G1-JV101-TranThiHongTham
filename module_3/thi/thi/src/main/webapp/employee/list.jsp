...
<body>
<h6><a href="/employee?action=create">Create</a></h6><br>
<form action="/employee" class="mb-3">
        ...
        <tr>
            ...
            <td>
                <button type="button" class="btn btn-warning"
                        onclick="handleShowDelete('${employee.idEmployee}','${employee.name}')"
                        data-mdb-ripple-init data-mdb-modal-init data-mdb-target="#deleteModal">Delete
                </button>
            </td>
<%--            <td>--%>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-mdb-ripple-init data-mdb-dismiss="modal">Close
                </button>
...
<script>
    function handleShowDelete(id, name) {
        ...
        document.getElementById("confirm-delete").href = "/employee?action=delete&idEmpl=" + id;
    }
</script>
<!-- MDB -->
<script
